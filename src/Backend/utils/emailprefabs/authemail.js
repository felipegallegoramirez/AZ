...
<div class="inf" style="text-align: center;">
    ...
    <a href="localhost:4200/${id}/${code}" style="text-decoration: none;color: black;"><h3 style="font-size: 25px;margin: 10px;" >Click <b style="color:#16A571;">aqui</b> para ingresar </h3></a>
